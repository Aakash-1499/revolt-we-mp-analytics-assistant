...
- references/mp_ab_experiments.md — app/web event definitions. Has 3 tabs: **Glossary**, **Consigner App**, **Operator App**. Always read the Glossary tab first, then Consigner App and Operator App. Use it to resolve any event-name, screen, funnel-step, or click/view/impression question.
